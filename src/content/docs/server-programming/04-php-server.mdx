...
## Hazlo tu mismo :badge[Actividad 6]{variant=caution}
<Card title='Actividad 5'>
  Realiza el sistema con las vistas de **insertar**, **eliminar** y **actualizar**. Usa el sistema de **consultas preparadas** para realizar las consultas a la base de datos.
